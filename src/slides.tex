...
\begin{frame}
  \frametitle{Urheberrecht (1)}
    \begin{itemize}
      ...
      \item<9-> Monopolrechte (Verfielfältigung, Verbreitung, \dots)
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item<3-> Charityware
        \item<4-> Pizzaware
        \item<5-> eigene Lizenztexte
        \item<6-> unhandlich, wer möchte jedes mal die Lizenz lesen müssen?
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item<1-> Materialien sind wie folgt zugänglich:
            \begin{itemize}
                \item<2-> ohne Einschränkung,
                \item<3-> in einem freien Format,
                \item<4-> unter einer offenen Lizenzen 
            \end{itemize}
        \item<5-> Begriff umfasst alle Arten von (Lehr-)Materialien
        \item<6-> Idee: Wissensunterschiede zwischen Industrienationen und Entwicklungsländern abbauen
        \item<7-> 2007: Cape Town Open Education Declaration
    \end{itemize}
\end{frame}
