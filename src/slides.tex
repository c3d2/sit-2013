...
\begin{frame}
    \frametitle{Open Educational Resources I}
    \begin{itemize}
...
\begin{frame}
    \frametitle{OER II}
    \begin{itemize}
        \item<2-> Verschiedene Finanzierungsmodelle
        \item<3-> Crowdfunding (Schulbuch-O-Mat)
        \item<4-> Fördergelder
        \item<5-> Wissenschaftliche Forschung an Universitäten
        \end{itemize}
    \end{frame}

\begin{frame}
    \frametitle{OER III: Beispiel Polen}
    \begin{itemize}
        \item Polnische Regierung lässt von Universitäten freie Lehrmaterialien erstellen
        \item Ziele (u. a.):
            \begin{enumerate}
                \item Familien finanziell entlasten
                \item Material aktuell halten
                \item \ldots
            \end{enumerate}
        \item Gegenkampagne der Schulbuchverlage
    \end{itemize}
\end{frame}
